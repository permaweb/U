  ...
  return props.order && stateObj ? (
    <S.Wrapper className={'wrapper'}>
      ...
      <S.Content>
        <S.HeaderWrapper>
          <p>
            {language.notificationHeader(convertCamelCase(props.orderType))}
          </p>
        </S.HeaderWrapper>
        <S.DetailWrapper>
          <S.DetailHeaderWrapper>
            {Object.keys(props.order.orderLine).map(
          ...
          <S.DetailBodyWrapper>
            ...
            <S.DetailLine>
              <p
                className={'p-positive'}
              >{`+${props.order.orderLine.mint} ${language.pcTokens}`}</p>
            </S.DetailLine>
            <S.DetailLine>
