...
export const DetailLine = styled.div<{ type: MintStatusType, ownerLine: boolean }>`
    display: flex;
    justify-content: space-between;
    padding: 6.5px 20px;
    background: ${(props) => props.ownerLine ? props.theme.colors.orderLine.ownerLine.background : getDetailLineBackground(props.type, props.theme)};
    p {
