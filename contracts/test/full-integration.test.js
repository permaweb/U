...
// test.skip("mint 10 rebar with wallet1", async () => {
...
// test.skip("transfer 5 to wallet 2", async () => {
//   await connectedWallet1.writeInteraction({
//     function: "transfer",
...
// test.skip("allow 2 with wallet 2 (to wallet 1) - allow 1 with wallet 2", async () => {
...
// test.skip("claim 2 with wallet 1", async () => {
//   await connectedWallet1.writeInteraction({
//     function: "claim",
...
// test.skip("should claim with different txID", async () => {
//   await connectedWallet1.writeInteraction({
//     function: "claim",
...
// test.skip("check balance with target", async () => {
...
// test.skip("check balance without target", async () => {
//   const balanceFunc = await connectedWallet1.viewState({
//     function: "balance",
//   });
